...
int main() {
    ...
    date1 = DayOfYear(10, 31); // explicit call to constructor
...
// Consists of a colon followed by a list of some or all the member
//  variables separated by commas
// Each member variable is followed by its initializing value in
//  parentheses.
DayOfYear::DayOfYear(int m, int d): month(m), day(d) {
    testDate();
}

DayOfYear::DayOfYear(int m): month(m), day(1) {
    testDate();
}
